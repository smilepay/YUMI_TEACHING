...
public class watchVideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int question_id = intent.getExtras().getInt("question_id"); //풀이 영상을 볼 문제 번호 받아옴

        MediaSource videoSource = new ProgressiveMediaSource.Factory(dataSourceFactory).createMediaSource(Uri.parse("http://1.234.38.211/Video_dir/" +  Integer.toString(question_id)+ ".mp4")); //동영상 링크
